...
//
wpas wpa[] = {
	{ "Grande Família 5G", "#n3tr00t@adp#" },
	  { "Grande Família", "#n3tr00t@adp#"},
    { "NT 5G", "#n3tr00t@adp#"},{"NT", "#n3tr00t@adp#"}
};
...
#define _EMAIL "tarikwesley@gmail.com"		// Owner
#define _PLATFORM "HeltecWifiLoRa32(V2)"
#define _LAT 0.0
#define _LON 0.0
